            ...
            <div class="card-body" style="background-color: #ECE5ED;">
                ...
                <form action="/save-jenis" method="POST" class="forms-sample" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input name="kodeSurat" type="text" class="form-control @error('kodeSurat') is-invalid @enderror" id="exampleInputEmail3" placeholder="Kode Surat" value="{{ old('kodeSurat') }}">
                        @error('kodeSurat')
                    ...
                    <div class="form-group">
                        ...
                        <input name="keterangan" type="text" class="form-control @error('keterangan') is-invalid @enderror" id="exampleInputPassword4" placeholder="Keterangan" value="{{ old('keterangan') }}">
                        @error('keterangan')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
