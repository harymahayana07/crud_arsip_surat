...
<div class="content-wrapper">
    <div class="page-header">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a>Jenis Surat</a></li>
            ...
            <div class="card-body" style="background-color: #ECE5ED;">
                ...
                <form action="/update-jenis/{{ $data->id }}" method="POST" class="forms-sample" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <input type="hidden" name="id" class="form-control" id="exampleInputName1" placeholder="Id Jenis" value="{{ $data->id }}">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail3">Kode Surat</label>
                        <input type="text" name="kodeSurat" class="form-control" id="exampleInputEmail3" placeholder="Kode Surat" value="{{ $data->kodeSurat }}">
                        @error('kodeSurat')
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="keterangan" class="form-control" id="exampleInputPassword4" placeholder="Keterangan" value="{{ $data->keterangan }}">
                        @error('keterangan')
                        <p class="text-danger pt-1"><small> {{ $message }}</small></p>
                        @enderror
                    </div>
